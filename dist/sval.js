    ...
    ***************************************************************************** */
    ...
    function AssignmentExpression$1(node, scope) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    value_1 = _b.sent();
                    return [5, __values(pattern(left, scope, { feed: value_1 }))];
                case 6: return [2, _b.sent()];
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [3, 4];
                case 2: return [5, __values(pattern(value, scope, { kind: kind, hoist: hoist, onlyBlock: onlyBlock }))];
                case 3:
                    _e.sent();
                    _e.label = 4;
                case 4: return [3, 7];
                ...
                case 11:
                    ...
                    return [3, 14];
                case 12: return [5, __values(pattern(value, scope, { kind: kind, feed: feed[key] }))];
                case 13:
                    _e.sent();
                    _e.label = 14;
                case 14: return [3, 17];
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [3, 4];
                case 2: return [5, __values(pattern(element, scope, { kind: kind, hoist: hoist, onlyBlock: onlyBlock }))];
                case 3:
                    _d.sent();
                    _d.label = 4;
                case 4: return [3, 13];
                ...
                case 10:
                    _d.sent();
                    return [3, 13];
                case 11: return [5, __values(pattern(element, scope, { kind: kind, feed: feed[i] }))];
                case 12:
                    _d.sent();
                    _d.label = 13;
                case 13:
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [3, 3];
                case 1: return [5, __values(pattern(arg, scope, { kind: kind, hoist: hoist, onlyBlock: onlyBlock }))];
                case 2:
                    _d.sent();
                    _d.label = 3;
                case 3: return [3, 10];
                ...
                case 6:
                    ...
                    _d.label = 7;
                case 7: return [3, 10];
                case 8: return [5, __values(pattern(arg, scope, { kind: kind, feed: feed }))];
                case 9:
                    _d.sent();
                    _d.label = 10;
                case 10: return [2];
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    ...
                    return [3, 6];
                case 4: return [5, __values(pattern(left, scope, { kind: kind, hoist: hoist, onlyBlock: onlyBlock }))];
                case 5:
                    _f.sent();
                    _f.label = 6;
                case 6: return [3, 10];
                case 7:
                    ...
                    return [3, 10];
                case 8: return [5, __values(pattern(left, scope, { kind: kind, feed: feed }))];
                case 9:
                    _f.sent();
                    _f.label = 10;
                case 10: return [2];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [5, __values(WhileStatement$1(node.body, scope, { label: label }))];
                case 1: return [2, _a.sent()];
                case 2:
                    if (!(node.body.type === 'DoWhileStatement')) return [3, 4];
                    return [5, __values(DoWhileStatement$1(node.body, scope, { label: label }))];
                case 3: return [2, _a.sent()];
                case 4:
                    if (!(node.body.type === 'ForStatement')) return [3, 6];
                    return [5, __values(ForStatement$1(node.body, scope, { label: label }))];
                case 5: return [2, _a.sent()];
                case 6:
                    if (!(node.body.type === 'ForInStatement')) return [3, 8];
                    return [5, __values(ForInStatement$1(node.body, scope, { label: label }))];
                case 7: return [2, _a.sent()];
                case 8:
                    if (!(node.body.type === 'ForOfStatement')) return [3, 10];
                    return [5, __values(ForOfStatement$1(node.body, scope, { label: label }))];
                case 9: return [2, _a.sent()];
                case 10:
                    if (!(node.body.type === 'BlockStatement')) return [3, 12];
                    return [5, __values(BlockStatement$1(node.body, scope, { label: label }))];
                case 11: return [2, _a.sent()];
                case 12:
                    if (!(node.body.type === 'WithStatement')) return [3, 14];
                    return [5, __values(WithStatement$1(node.body, scope, { label: label }))];
                case 13: return [2, _a.sent()];
                case 14:
                    if (!(node.body.type === 'IfStatement')) return [3, 16];
                    return [5, __values(IfStatement$1(node.body, scope, { label: label }))];
                case 15: return [2, _a.sent()];
                case 16:
                    if (!(node.body.type === 'SwitchStatement')) return [3, 18];
                    return [5, __values(SwitchStatement$1(node.body, scope, { label: label }))];
    ...
    function WithStatement$1(node, scope, options) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [5, __values(evaluate$1(node.body, withScope))];
                case 2:
                    result = _c.sent();
                    if (result === BREAK) {
                        if (result.LABEL && result.LABEL === options.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [3, 5];
                case 3: return [5, __values(pattern(param, scope, { feed: err_1 }))];
                case 4:
                    _a.sent();
                    _a.label = 5;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [3, 3];
                case 1: return [5, __values(pattern(node.id, scope, { kind: kind, hoist: hoist, onlyBlock: onlyBlock }))];
                case 2:
                    _e.sent();
                    _e.label = 3;
                case 3: return [3, 10];
                ...
                case 7:
                    ...
                    return [3, 10];
                case 8: return [5, __values(pattern(node.id, scope, { kind: kind, feed: value }))];
                case 9:
                    _e.sent();
                    _e.label = 10;
                case 10: return [2];
    ...
    function AssignmentExpression(node, scope) {
        ...
        if (left.type === 'Identifier') {
            ...
            return pattern$1(left, scope, { feed: value_1 });
        }
    ...
    function LabeledStatement(node, scope) {
        ...
        if (node.body.type === 'WhileStatement') {
            return WhileStatement(node.body, scope, { label: label });
        }
        if (node.body.type === 'DoWhileStatement') {
            return DoWhileStatement(node.body, scope, { label: label });
        }
        if (node.body.type === 'ForStatement') {
            return ForStatement(node.body, scope, { label: label });
        }
        if (node.body.type === 'ForInStatement') {
            return ForInStatement(node.body, scope, { label: label });
        }
        if (node.body.type === 'ForOfStatement') {
            return ForOfStatement(node.body, scope, { label: label });
        }
        if (node.body.type === 'BlockStatement') {
            return BlockStatement(node.body, scope, { label: label });
        }
        if (node.body.type === 'WithStatement') {
            return WithStatement(node.body, scope, { label: label });
        }
        if (node.body.type === 'IfStatement') {
            return IfStatement(node.body, scope, { label: label });
        }
        if (node.body.type === 'SwitchStatement') {
            return SwitchStatement(node.body, scope, { label: label });
        }
    ...
    function WithStatement(node, scope, options) {
        ...
        var result = evaluate(node.body, withScope);
        if (result === BREAK) {
            if (result.LABEL && result.LABEL === options.label) {
                return;
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        _a.sent();
                        return [3, 9];
                    case 7: return [5, __values(pattern(param, subScope, { kind: 'var', feed: args[i] }))];
                    case 8:
                        _a.sent();
                        _a.label = 9;
                    case 9:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    variable.set(value);
                    return [3, 6];
                case 4: return [5, __values(pattern(left, scope, { feed: value }))];
                case 5:
                    _a.sent();
                    _a.label = 6;
                case 6:
        ...
        Sval.prototype.run = function (code) {
            ...
            if (this.options.sourceType === 'module' && (this.options.ecmaVersion === 'latest'
                ...
                runAsync((function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [5, __values(hoist(ast, scope))];
                            case 1:
                                _a.sent();
                                return [5, __values(evaluate$1(ast, scope))];
                            case 2:
                                _a.sent();
                                return [2];
                        }
