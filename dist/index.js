(function (global, factory) {
    ...
    ***************************************************************************** */
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    subScope = invasived ? scope : new Scope$1(scope);
                    ...
                    switch (_a.label) {
                        case 0:
                            if (node.type !== 'ArrowFunctionExpression') {
                                subScope = new Scope$1(scope, true);
    ...
    var evaluateOps = assign({}, declaration, expression, identifier, literal$1, pattern, program, statement);
    ...
    var Sval = (function () {
        function Sval(options) {
            if (options === void 0) { options = {}; }
            this.options = {};
            this.scope = new Scope$1(null, true);
            this.exports = {};
        ...
        Sval.prototype.run = function (input) {
            var ast = parse(input, this.options);
