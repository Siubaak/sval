...
import { define, inherits } from '../share/util';
import { Identifier } from '../evaluate_n/identifier';
import { BlockStatement } from './statement';
import Scope from '../scope';
import evaluate from '.';
import { ObjectPattern, ArrayPattern, RestElement, AssignmentPattern } from './pattern';
export function hoist(block, scope, options = {}) {
...
export function pattern(node, scope, options = {}) {
    switch (node.type) {
        case 'ObjectPattern':
...
export function createFunc(node, scope, options = {}) {
...
export function createClass(node, scope) {
...
export function ForXHandler(node, scope, options) {
    const { value } = options;
